        ...
        const loadComanda = async () => {
            if (id && id !== 'new') {
                try {
                    ...
                    const mensagem =
                        error.apiMessage || 'Erro ao carregar comanda';
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const comandaData = {
                ...
                // Enviar null se não informado — a API espera int ou null
                cliente_id: data.cliente_id ? parseInt(data.cliente_id) : null,

                funcionario_id:
                    id && id !== 'new'
                        ? parseInt(data.funcionario_id)
                        : user?.id,
            ...
            if (id && id !== 'new') {
                ...
                savedComanda = await comandaService.update(
                    id,
                    comandaData
                );
                ...
                // Criar nova comanda
                savedComanda = await comandaService.create(
                    comandaData
                );
            ...
            const mensagem =
                error.apiMessage || 'Erro ao salvar comanda';
                    ...
                    render={({ field }) => (
                        <TextField
                            ...
                            helperText={
                                ...
                                'Identificador da comanda (número ou nome)'
                            }
