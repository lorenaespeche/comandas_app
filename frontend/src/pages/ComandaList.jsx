...
function ComandaList() {
    ...
    const handleView = (comanda) =>
        navigate(`/comanda/view/${comanda.id}`); // Navega para a página de visualização da comanda

    const handleEdit = (comanda) =>
        navigate(`/comanda/edit/${comanda.id}`); // Navega para a página de edição da comanda

    const handleAddItem = (comanda) =>
        navigate(`/comanda/consumo/${comanda.id}`); // Navega para página de consumo
        ...
        showConfirm(
            ...
            async () => {
                try {
                    ...
                    const updatedComandas = comandas.filter(
                        (c) => c.id !== comanda.id
                    );
                    ...
                    const mensagem =
                        error.apiMessage || 'Erro ao cancelar comanda';
        ...
        showConfirm(
            ...
            async () => {
                try {
                    ...
                    const mensagem =
                        error.apiMessage || 'Erro ao excluir comanda';
    ...
    useEffect(() => {
        const loadComandas = async () => {
            try {
                ...
                const mensagem =
                    error.apiMessage || 'Erro ao carregar comandas';
        ...
        <PageLayout title="Comandas" actions={actions}>
            ...
            <Box sx={{ display: { xs: 'block', md: 'none' } }}>
                {comandas.map((comanda, index) =>
                    renderMobileCard(comanda, index)
                )}
            </Box>
